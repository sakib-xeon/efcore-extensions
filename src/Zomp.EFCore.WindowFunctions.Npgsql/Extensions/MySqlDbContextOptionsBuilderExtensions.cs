...
using Zomp.EFCore.WindowFunctions.MySql.Query.Internal;
...
public static class MySqlDbContextOptionsBuilderExtensions
{
    ...
    public static MySqlDbContextOptionsBuilder UseWindowFunctions(
        this MySqlDbContextOptionsBuilder builder) => builder.AddOrUpdateExtension();

    private static MySqlDbContextOptionsBuilder AddOrUpdateExtension(
        this MySqlDbContextOptionsBuilder builder)
    {
        ...
        var extension = coreOptionsBuilder.Options.FindExtension<MySqlDbContextOptionsExtension>() ?? new MySqlDbContextOptionsExtension();
