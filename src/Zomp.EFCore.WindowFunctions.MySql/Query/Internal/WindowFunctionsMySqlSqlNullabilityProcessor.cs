...
/// </summary>
/// <remarks>
/// Initializes a new instance of the <see cref="WindowFunctionsMySqlSqlNullabilityProcessor"/> class.
/// </remarks>
public class WindowFunctionsMySqlSqlNullabilityProcessor : MySqlSqlNullabilityProcessor
{
#if !EF_CORE_8
    /// <summary>
    /// Initializes a new instance of the <see cref="WindowFunctionsMySqlSqlNullabilityProcessor"/> class.
    ...
    public WindowFunctionsMySqlSqlNullabilityProcessor(RelationalParameterBasedSqlProcessorDependencies dependencies, RelationalParameterBasedSqlProcessorParameters parameters)
    ...
    [SuppressMessage("Style", "IDE0290:Use primary constructor", Justification = "EF Core 8")]
    public WindowFunctionsMySqlSqlNullabilityProcessor(RelationalParameterBasedSqlProcessorDependencies dependencies, bool useRelationalNulls)
